// apps/teacher-portal/app/api/proxy/teacher/assignments/route.ts
...
export async function POST(request: NextRequest) {
    try {
        ...
        console.log('========================================');
        console.log('➕ POST /api/proxy/teacher/assignments');
        ...
        const response = await fetch(`${API_BASE_URL}/api/enseignant/devoirs`, {
            method: 'POST',
            headers: {
