// apps/student-portal/app/api/proxy/student/courses/route.ts
...
export async function GET(request: NextRequest) {
    try {
        ...
        console.log('========================================');
        console.log('📥 GET /api/proxy/student/courses');
        console.log('========================================');
        ...
        const response = await fetch(`${API_BASE_URL}/api/etudiant/cours`, {
            method: 'GET',
            headers: {
