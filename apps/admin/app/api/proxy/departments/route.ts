// apps/admin/app/api/proxy/departments/route.ts
...
export async function GET(request: NextRequest) {
    try {
        ...
        console.log('========================================');
        console.log('📥 GET /api/proxy/departments - Liste');
        console.log('========================================');
        ...
        const response = await fetch(`${API_BASE_URL}/api/admin/departements`, {
            method: 'GET',
            headers: {
...
export async function POST(request: NextRequest) {
    try {
        ...
        console.log('========================================');
        console.log('➕ POST /api/proxy/departments - Créer');
        ...
        const data = await response.json();
        console.log('✅ Département créé:', data.id);
        console.log('========================================');
