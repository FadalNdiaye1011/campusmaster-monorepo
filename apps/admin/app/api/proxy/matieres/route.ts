// apps/admin/app/api/proxy/matieres/route.ts
...
export async function GET(request: NextRequest) {
    try {
        ...
        console.log('========================================');
        console.log('📥 GET /api/proxy/matieres - Liste');
        console.log('========================================');
        ...
        const response = await fetch(`${API_BASE_URL}/api/admin/matieres`, {
            method: 'GET',
            headers: {
...
export async function POST(request: NextRequest) {
    try {
        ...
        console.log('========================================');
        console.log('➕ POST /api/proxy/matieres - Créer');
        ...
        const data = await response.json();
        console.log('✅ Matière créée:', data.id);
        console.log('========================================');
